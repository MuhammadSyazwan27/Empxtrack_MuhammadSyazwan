...
WebUI.click(findTestObject('Dashboard/Leave/i_sick_leave_triple_dots'))

WebUI.click(findTestObject('Dashboard/Leave/i_Apply_arroww_sick_leave'))
...
WebUI.setText(findTestObject('Dashboard/Leave/textarea_dataObject.reasonForLeave'), 'sick')
