...
WebUI.setText(findTestObject('Dashboard/Event_Task/Page_Home page/input_Subject_subject'), '')

WebUI.setText(findTestObject('Dashboard/Event_Task/Page_Home page/input_Location_location'), '')

WebUI.click(findTestObject('Dashboard/Event_Task/Page_Home page/a_Save'))

WebUI.verifyElementPresent(findTestObject('Dashboard/Event_Task/Page_Home page/div_verify_error_Please specify the subject'), 
    0)
