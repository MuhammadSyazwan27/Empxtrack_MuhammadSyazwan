...
WebUI.waitForElementVisible(findTestObject('Menu Toolbar/div_verify_error_suggestion_Please specify area of suggestion'), 
    0)

WebUI.verifyElementPresent(findTestObject('Menu Toolbar/div_verify_error_suggestion_Please specify area of suggestion'), 
    0)
