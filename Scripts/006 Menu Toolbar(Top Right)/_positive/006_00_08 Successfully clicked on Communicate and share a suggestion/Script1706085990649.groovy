...
WebUI.click(findTestObject('Menu Toolbar/textarea_Communication_Suggestion_yourSuggestion'))

result = CustomKeywords.'changeSubject.SuggestionChangeMenu.addSuggestionSubject'(yourSuggestion)

WebUI.setText(findTestObject('Menu Toolbar/textarea_Communication_Suggestion_yourSuggestion'), result)
